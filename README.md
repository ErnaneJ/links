<h1 align="center">
  <strong> <img style="transform:translateY(6px);" src="./.github/favicon.png" height="30px"/> Links | Ernane.dev </strong>
</h1>

<div align="center" style="border-radius: 10px;">
  <img alt="Me Preview" style="border-radius: 10px;" src=".github/preview.png" width="100%">
</div>
